USE ringHonorDB;
INSERT INTO team (team_name, history, logo)
VALUES (
    "Baltimore Ravens",
...
VALUES -- Baltimore Ravens
  ...
  (
    "Paul Brown",
    "Founding Owner, Head Coach, General Manager",
    "Cincinnati Bengals",
    NULL,
    "1968 - 1991",
    2021
  ...
  (
    ...
    "Founding Owner",
    "Kansas City Chiefs",
    "One of the key founders of the AFL.",
    "1960 - 2006",
    1970
  ),
  (
  ...
  (
    "The 1963 AFL Championship Team",
    NULL,
    "Los Angeles Chargers",
    NULL,
    "1963",
  ...
  (
    ...
    "OT",
    "Minnesota Vikings",
    "Died in 2001 due to a heat stroke",
    "1995 - 2000",
    2001
  ),
  (
  ...
  (
    "Bill Parcells",
    "LB Coach, Defensive Coordinator, Head Coach",
    "New York Giants",
    NULL,
    "1979, 1981 - 1990",
    2010
  ...
  (
    "George Seifert",
    "DB Coach, Defensive Coordinator, Head Coach",
    "San Francisco 49ers",
    NULL,
