const Disclaimer = () => {
  return (
    ...
    <p>
      ...
      disclaimer, please feel free to contact us by email <a href="mailto: fameofhonors@gmail.com">here</a>.
    </p>
    <p>
    ...
    <h3 className="disclaimer-header">Consent</h3>
    <p>
      By using our website, you hereby consent to our disclaimer and agree to
      its terms.
    </p>

    <h3 className="disclaimer-header">Update</h3>
    <p>
